...
public:
	...
	glm::mat4 getVPTTransf(Camera& pCamera, const glm::mat4& pProjMatrix);
	glm::mat4 getWVPTransf(Camera& pCamera, const glm::mat4& pProjMatrix);
	glm::mat4 getWVOrthoPTransf(Camera& pCamera, const glm::mat4& pOrthoProjMatrix);
	glm::mat4 getWVTransf(Camera& pCamera);
	glm::mat4 getViewTransf(Camera& pCamera);
